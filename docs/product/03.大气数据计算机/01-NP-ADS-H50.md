...
​		NP-ADS-H05是NextPilot团队研发的工业级空速计，其内置高性能的集成式数字压力传感器和气压传感器，可测量飞行过程中静压、动压、气压高度，完成高度和速度测量，采用航空连接器，稳定可靠。
...
​		空速计提供了两个连接空速管的接头，PS为静压管，PT为动压管。

​		空速计提供了航空连接器，型号为J30J-21ZKW-J，接口布局如下图右侧所示。
